...
/* Block signals for system '<S9>/VSP' */
typedef struct {
  real_T F_x;                          /* '<S9>/VSP' */
  real_T F_y;                          /* '<S9>/VSP' */
} B_VSP_CSE1_HIL_u_T;
...
typedef struct {
  ...
  real_T Velocity[3];                  /* '<S10>/Velocity' */
  real_T u_BT;                         /* '<S8>/u_BT' */
  real_T u_VSP1;                       /* '<S8>/u_VSP1' */
  real_T u_VSP2;                       /* '<S8>/u_VSP2' */
  real_T alpha_VSP1;                   /* '<S8>/alpha_VSP1' */
  real_T alpha_VSP2;                   /* '<S8>/alpha_VSP2' */
  real_T omega_VSP1;                   /* '<S8>/omega_VSP1' */
  real_T omega_VSP2;                   /* '<S8>/omega_VSP2' */
  real_T Sum;                          /* '<S9>/Sum' */
  real_T Add1;                         /* '<S9>/Add1' */
  real_T Gain1_i;                      /* '<S9>/Gain1' */
  real_T Add;                          /* '<S9>/Add' */
  ...
  B_VSP_CSE1_HIL_u_T sf_VSP1;          /* '<S9>/VSP1' */
  B_VSP_CSE1_HIL_u_T sf_VSP;           /* '<S9>/VSP' */
} B_CSE1_HIL_u_T;
...
typedef struct {
  ...
  real_T r_dot_DWORK1;                 /* '<S6>/r_dot' */
  real_T u_dot_DWORK1;                 /* '<S6>/u_dot' */
  real_T v_dot_DWORK1;                 /* '<S6>/v_dot' */
  real_T zeroout_DWORK1;               /* '<S6>/zeroout' */
  real_T r_dot1_DWORK1;                /* '<S6>/r_dot1' */
  real_T u_dot1_DWORK1;                /* '<S6>/u_dot1' */
  real_T v_dot1_DWORK1;                /* '<S6>/v_dot1' */
  real_T X_DWORK1;                     /* '<S7>/X' */
  real_T Y_DWORK1;                     /* '<S7>/Y' */
  real_T N_DWORK1;                     /* '<S7>/N' */
  ...
  uint8_T x_DWORK2[11];                /* '<S3>/x' */
  uint8_T y_DWORK2[11];                /* '<S3>/y' */
  uint8_T psi_DWORK2[11];              /* '<S3>/psi' */
  uint8_T r_DWORK2[11];                /* '<S5>/r' */
  uint8_T u_DWORK2[11];                /* '<S5>/u' */
  uint8_T v_DWORK2[11];                /* '<S5>/v' */
  uint8_T u_BT_DWORK2[11];             /* '<S8>/u_BT' */
  uint8_T u_VSP1_DWORK2[11];           /* '<S8>/u_VSP1' */
  uint8_T u_VSP2_DWORK2[11];           /* '<S8>/u_VSP2' */
  uint8_T alpha_VSP1_DWORK2[11];       /* '<S8>/alpha_VSP1' */
  uint8_T alpha_VSP2_DWORK2[11];       /* '<S8>/alpha_VSP2' */
  uint8_T omega_VSP1_DWORK2[11];       /* '<S8>/omega_VSP1' */
  uint8_T omega_VSP2_DWORK2[11];       /* '<S8>/omega_VSP2' */
  uint8_T r_dot_DWORK2[11];            /* '<S6>/r_dot' */
  uint8_T u_dot_DWORK2[11];            /* '<S6>/u_dot' */
  uint8_T v_dot_DWORK2[11];            /* '<S6>/v_dot' */
  uint8_T zeroout_DWORK2[11];          /* '<S6>/zeroout' */
  uint8_T r_dot1_DWORK2[11];           /* '<S6>/r_dot1' */
  uint8_T u_dot1_DWORK2[11];           /* '<S6>/u_dot1' */
  uint8_T v_dot1_DWORK2[11];           /* '<S6>/v_dot1' */
  uint8_T X_DWORK2[11];                /* '<S7>/X' */
  uint8_T Y_DWORK2[11];                /* '<S7>/Y' */
  uint8_T N_DWORK2[11];                /* '<S7>/N' */
  uint8_T psi_0_DWORK2[11];            /* '<S4>/psi_0' */
  uint8_T x_0_DWORK2[11];              /* '<S4>/x_0' */
  uint8_T y_0_DWORK2[11];              /* '<S4>/y_0' */
} DW_CSE1_HIL_u_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Position_CSTATE[3];           /* '<S10>/Position' */
  real_T Velocity_CSTATE[3];           /* '<S10>/Velocity' */
} X_CSE1_HIL_u_T;
...
/* State disabled  */
typedef struct {
  boolean_T Position_CSTATE[3];        /* '<S10>/Position' */
  boolean_T Velocity_CSTATE[3];        /* '<S10>/Velocity' */
} XDis_CSE1_HIL_u_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Position_Reset_ZCE;       /* '<S10>/Position' */
  ZCSigState Velocity_Reset_ZCE;       /* '<S10>/Velocity' */
 ...
 * '<S2>'   : 'CSE1_HIL_u/Wrap2QualisysOutput '
 * '<S3>'   : 'CSE1_HIL_u/eta'
 * '<S4>'   : 'CSE1_HIL_u/eta_0'
 * '<S5>'   : 'CSE1_HIL_u/nu'
 * '<S6>'   : 'CSE1_HIL_u/nu_dot'
 * '<S7>'   : 'CSE1_HIL_u/tau'
 * '<S8>'   : 'CSE1_HIL_u/u'
 * '<S9>'   : 'CSE1_HIL_u/Simulator_CSE1/Command2force'
 * '<S10>'  : 'CSE1_HIL_u/Simulator_CSE1/EquationsOfMotion_FossenModel'
 * '<S11>'  : 'CSE1_HIL_u/Simulator_CSE1/Command2force/Bow thruster'
 * '<S12>'  : 'CSE1_HIL_u/Simulator_CSE1/Command2force/VSP'
 * '<S13>'  : 'CSE1_HIL_u/Simulator_CSE1/Command2force/VSP1'
 * '<S14>'  : 'CSE1_HIL_u/Simulator_CSE1/EquationsOfMotion_FossenModel/kinematics'
 * '<S15>'  : 'CSE1_HIL_u/Simulator_CSE1/EquationsOfMotion_FossenModel/kinetics'
 * '<S16>'  : 'CSE1_HIL_u/Wrap2QualisysOutput /Wrap2psi'
 */
